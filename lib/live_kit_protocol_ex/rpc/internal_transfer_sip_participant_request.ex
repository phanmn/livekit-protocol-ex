...
defmodule LiveKitProtocolEx.Rpc.InternalTransferSIPParticipantRequest do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(LiveKitProtocolEx.Rpc.InternalTransferSIPParticipantRequest)
          )
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LiveKitProtocolEx.Rpc.InternalTransferSIPParticipantRequest,
      syntax: :proto3
    }
  end
end
