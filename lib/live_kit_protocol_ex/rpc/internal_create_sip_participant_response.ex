...
defmodule LiveKitProtocolEx.Rpc.InternalCreateSIPParticipantResponse do
  @moduledoc false
  ...
  defstruct sip_call_id: "", participant_identity: "", participant_id: "", __uf__: []
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(LiveKitProtocolEx.Rpc.InternalCreateSIPParticipantResponse)
          )
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LiveKitProtocolEx.Rpc.InternalCreateSIPParticipantResponse,
      syntax: :proto3
    }
  end
end
