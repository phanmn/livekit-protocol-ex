...
defmodule LiveKitProtocolEx.SIPCodec do
  @moduledoc false
  ...
  (
    ...
    defp encode_rate({acc, acc_size}, msg) do
      if msg.rate == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.rate)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LiveKitProtocolEx.SIPCodec))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LiveKitProtocolEx.SIPCodec,
      syntax: :proto3
    }
  end
end
