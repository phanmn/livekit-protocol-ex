...
defmodule LiveKitProtocolEx.ICEConfig do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          preference_publisher: atom(),
          preference_subscriber: atom(),
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct preference_publisher: :ICT_NONE, preference_subscriber: :ICT_NONE, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_preference_publisher(msg)
        |> encode_preference_subscriber(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_preference_publisher({acc, acc_size}, msg) do
      if msg.preference_publisher == :ICT_NONE do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.preference_publisher
          |> LiveKitProtocolEx.ICECandidateType.encode()
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:preference_publisher, "invalid field value"),
                __STACKTRACE__
    end

    defp encode_preference_subscriber({acc, acc_size}, msg) do
      if msg.preference_subscriber == :ICT_NONE do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.preference_subscriber
          |> LiveKitProtocolEx.ICECandidateType.encode()
          |> Protox.Encode.encode_enum()
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:preference_subscriber, "invalid field value"),
                __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LiveKitProtocolEx.ICEConfig))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LiveKitProtocolEx.ICECandidateType)
              {[preference_publisher: value], rest}

            <<1::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LiveKitProtocolEx.ICECandidateType)
              {[preference_subscriber: value], rest}
  ...
  (
    ...
    def default(:preference_publisher) do
      {:ok, :ICT_NONE}
    end

    def default(:preference_subscriber) do
      {:ok, :ICT_NONE}
    end
    ...
    %{
      ...
      fields: %{
        preference_publisher: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :ICT_NONE},
          label: :optional,
          name: :preference_publisher,
          tag: 2,
          type: {:enum, LiveKitProtocolEx.ICECandidateType}
        },
        preference_subscriber: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :ICT_NONE},
          label: :optional,
          name: :preference_subscriber,
          tag: 1,
          type: {:enum, LiveKitProtocolEx.ICECandidateType}
        }
      },
      ...
      name: LiveKitProtocolEx.ICEConfig,
      syntax: :proto3
    }
  end
end
