...
defmodule LivekitProtocolEx.ProviderInfo do
  @moduledoc false
  ...
  defstruct type: :PROVIDER_TYPE_UNKNOWN, name: "", id: "", __uf__: []
  ...
  (
    ...
    defp encode_type({acc, acc_size}, msg) do
      if msg.type == :PROVIDER_TYPE_UNKNOWN do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.type |> LivekitProtocolEx.ProviderType.encode() |> Protox.Encode.encode_enum()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ProviderInfo))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LivekitProtocolEx.ProviderType)
              {[type: value], rest}
    ...
    %{
      ...
      fields: %{
        ...
        type: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :PROVIDER_TYPE_UNKNOWN},
          label: :optional,
          name: :type,
          tag: 3,
          type: {:enum, LivekitProtocolEx.ProviderType}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.ProviderInfo,
      syntax: :proto3
    }
  end
end
