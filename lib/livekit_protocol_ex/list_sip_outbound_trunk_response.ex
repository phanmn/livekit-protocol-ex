...
defmodule LivekitProtocolEx.ListSIPOutboundTrunkResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          items: [LivekitProtocolEx.SIPOutboundTrunkInfo.t()],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPOutboundTrunkResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[items: msg.items ++ [LivekitProtocolEx.SIPOutboundTrunkInfo.decode!(delimited)]],
               rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListSIPOutboundTrunkResponse,
      syntax: :proto3
    }
  end
end
