...
defmodule LivekitProtocolEx.SimulateJobRequest do
  @moduledoc false
  ...
  defstruct participant: nil, room: nil, type: :JT_ROOM, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SimulateJobRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SimulateJobRequest,
      syntax: :proto3
    }
  end
end
