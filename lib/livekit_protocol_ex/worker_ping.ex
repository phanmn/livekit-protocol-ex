...
defmodule LivekitProtocolEx.WorkerPing do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_timestamp(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.WorkerPing))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.WorkerPing,
      syntax: :proto3
    }
  end
end
