...
defmodule LivekitProtocolEx.MetricSample do
  @moduledoc false
  ...
  defstruct value: 0.0, normalized_timestamp: nil, timestamp_ms: 0, __uf__: []
  ...
  (
    ...
    defp encode_value({acc, acc_size}, msg) do
      if msg.value == 0.0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_float(msg.value)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MetricSample))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.MetricSample,
      syntax: :proto3
    }
  end
end
