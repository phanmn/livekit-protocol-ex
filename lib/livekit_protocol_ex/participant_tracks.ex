...
defmodule LivekitProtocolEx.ParticipantTracks do
  @moduledoc false
  ...
  defstruct track_sids: [], participant_sid: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ParticipantTracks))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ParticipantTracks,
      syntax: :proto3
    }
  end
end
