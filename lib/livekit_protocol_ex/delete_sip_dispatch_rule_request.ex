...
defmodule LivekitProtocolEx.DeleteSIPDispatchRuleRequest do
  @moduledoc false
  ...
  defstruct sip_dispatch_rule_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DeleteSIPDispatchRuleRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DeleteSIPDispatchRuleRequest,
      syntax: :proto3
    }
  end
end
