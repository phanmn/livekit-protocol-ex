...
defmodule LivekitProtocolEx.MuteTrackRequest do
  @moduledoc false
  ...
  defstruct muted: false, sid: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MuteTrackRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.MuteTrackRequest,
      syntax: :proto3
    }
  end
end
