...
defmodule LivekitProtocolEx.ListSIPInboundTrunkRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPInboundTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListSIPInboundTrunkRequest,
      syntax: :proto3
    }
  end
end
