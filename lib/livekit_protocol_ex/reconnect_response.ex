...
defmodule LivekitProtocolEx.ReconnectResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          last_message_seq: non_neg_integer(),
  ...
  (
    ...
    defp encode_last_message_seq({acc, acc_size}, msg) do
      if msg.last_message_seq == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.last_message_seq)
        {[" ", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:last_message_seq, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ReconnectResponse))
        end
      )
    )
  ...
  (
    ...
    def default(:last_message_seq) do
      {:ok, 0}
    end
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ReconnectResponse,
      syntax: :proto3
    }
  end
end
