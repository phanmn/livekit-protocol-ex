...
defmodule LivekitProtocolEx.ListIngressRequest do
  @moduledoc false
  ...
  defstruct ingress_id: "", room_name: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListIngressRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListIngressRequest,
      syntax: :proto3
    }
  end
end
