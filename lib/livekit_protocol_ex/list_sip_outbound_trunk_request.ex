...
defmodule LivekitProtocolEx.ListSIPOutboundTrunkRequest do
  @moduledoc false
  ...
  defstruct page: nil, numbers: [], trunk_ids: [], __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPOutboundTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListSIPOutboundTrunkRequest,
      syntax: :proto3
    }
  end
end
