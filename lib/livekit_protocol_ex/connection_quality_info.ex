...
defmodule LivekitProtocolEx.ConnectionQualityInfo do
  @moduledoc false
  ...
  defstruct score: 0.0, quality: :POOR, participant_sid: "", __uf__: []
  ...
  (
    ...
    defp encode_score({acc, acc_size}, msg) do
      if msg.score == 0.0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_float(msg.score)
    ...
    defp encode_quality({acc, acc_size}, msg) do
      if msg.quality == :POOR do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.quality
          |> LivekitProtocolEx.ConnectionQuality.encode()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ConnectionQualityInfo))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LivekitProtocolEx.ConnectionQuality)
              {[quality: value], rest}
    ...
    %{
      ...
      fields: %{
        ...
        quality: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :POOR},
          label: :optional,
          name: :quality,
          tag: 2,
          type: {:enum, LivekitProtocolEx.ConnectionQuality}
        },
        score: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.ConnectionQualityInfo,
      syntax: :proto3
    }
  end
end
