...
defmodule LivekitProtocolEx.ListIngressResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          items: [LivekitProtocolEx.IngressInfo.t()],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListIngressResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[items: msg.items ++ [LivekitProtocolEx.IngressInfo.decode!(delimited)]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListIngressResponse,
      syntax: :proto3
    }
  end
end
