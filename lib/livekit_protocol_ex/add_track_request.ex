...
defmodule LivekitProtocolEx.AddTrackRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          stereo: boolean(),
          sid: String.t(),
          simulcast_codecs: [LivekitProtocolEx.SimulcastCodec.t()],
  ...
  defstruct audio_features: [],
            backup_codec_policy: :PREFER_REGRESSION,
            stream: "",
            encryption: :NONE,
            disable_red: false,
            stereo: false,
  ...
  (
    ...
    defp encode_audio_features({acc, acc_size}, msg) do
      case msg.audio_features do
        ...
        values ->
          ...
          {["\x8A\x01", packed_bytes | acc], acc_size + 2 + packed_size}
      end
    rescue
      ArgumentError ->
    ...
    defp encode_simulcast_codecs({acc, acc_size}, msg) do
      case msg.simulcast_codecs do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:simulcast_codecs, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.AddTrackRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<10::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 simulcast_codecs:
                   msg.simulcast_codecs ++ [LivekitProtocolEx.SimulcastCodec.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def default(:simulcast_codecs) do
      {:error, :no_default_value}
    end
    ...
    %{
      ...
      fields: %{
        ...
        simulcast_codecs: %{
          ...
          tag: 10,
          type: {:message, LivekitProtocolEx.SimulcastCodec}
        },
        source: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.AddTrackRequest,
      syntax: :proto3
    }
  end
end
