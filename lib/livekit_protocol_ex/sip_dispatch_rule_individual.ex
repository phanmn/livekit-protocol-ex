...
defmodule LivekitProtocolEx.SIPDispatchRuleIndividual do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SIPDispatchRuleIndividual))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SIPDispatchRuleIndividual,
      syntax: :proto3
    }
  end
end
