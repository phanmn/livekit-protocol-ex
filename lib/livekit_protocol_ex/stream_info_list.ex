...
defmodule LivekitProtocolEx.StreamInfoList do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          info: [LivekitProtocolEx.StreamInfo.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct info: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_info(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.StreamInfoList))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[info: msg.info ++ [LivekitProtocolEx.StreamInfo.decode!(delimited)]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.StreamInfoList,
      syntax: :proto3
    }
  end
end
