...
defmodule LivekitProtocolEx.MuteRoomTrackRequest do
  @moduledoc false
  ...
  defstruct muted: false, track_sid: "", identity: "", room: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MuteRoomTrackRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.MuteRoomTrackRequest,
      syntax: :proto3
    }
  end
end
