...
defmodule LivekitProtocolEx.UpdateStreamRequest do
  @moduledoc false
  ...
  defstruct remove_output_urls: [], add_output_urls: [], egress_id: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_remove_output_urls(msg)
        |> encode_add_output_urls(msg)
        |> encode_egress_id(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_remove_output_urls({acc, acc_size}, msg) do
      case msg.remove_output_urls do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:remove_output_urls, "invalid field value"),
                __STACKTRACE__
    end

    defp encode_add_output_urls({acc, acc_size}, msg) do
      case msg.add_output_urls do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:add_output_urls, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateStreamRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 remove_output_urls:
                   msg.remove_output_urls ++ [Protox.Decode.validate_string!(delimited)]
               ], rest}
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 add_output_urls:
                   msg.add_output_urls ++ [Protox.Decode.validate_string!(delimited)]
               ], rest}
  ...
  (
    ...
    def default(:remove_output_urls) do
      {:error, :no_default_value}
    end

    def default(:add_output_urls) do
      {:error, :no_default_value}
    end
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateStreamRequest,
      syntax: :proto3
    }
  end
end
