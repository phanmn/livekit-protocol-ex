...
defmodule LivekitProtocolEx.ListRoomsResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          rooms: [LivekitProtocolEx.Room.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct rooms: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_rooms(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_rooms({acc, acc_size}, msg) do
      case msg.rooms do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:rooms, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListRoomsResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[rooms: msg.rooms ++ [LivekitProtocolEx.Room.decode!(delimited)]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListRoomsResponse,
      syntax: :proto3
    }
  end
end
