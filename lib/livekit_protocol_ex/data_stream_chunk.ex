...
defmodule LivekitProtocolEx.DataStream.Chunk do
  @moduledoc false
  ...
  defstruct iv: nil, version: 0, content: "", chunk_index: 0, stream_id: "", __uf__: []
  ...
  (
    ...
    defp encode_content({acc, acc_size}, msg) do
      if msg.content == "" do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_bytes(msg.content)
    ...
    defp encode_chunk_index({acc, acc_size}, msg) do
      if msg.chunk_index == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint64(msg.chunk_index)
        {["\x10", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:chunk_index, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DataStream.Chunk))
        end
      )
    )
    ...
    %{
      ...
      fields: %{
        ...
        iv: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_iv},
      ...
      name: LivekitProtocolEx.DataStream.Chunk,
      syntax: :proto3
    }
  end
end
