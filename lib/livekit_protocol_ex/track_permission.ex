...
defmodule LivekitProtocolEx.TrackPermission do
  @moduledoc false
  ...
  defstruct participant_identity: "",
            track_sids: [],
            all_tracks: false,
            participant_sid: "",
            __uf__: []
  ...
  (
    ...
    defp encode_all_tracks({acc, acc_size}, msg) do
      if msg.all_tracks == false do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_bool(msg.all_tracks)
        {["\x10", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:all_tracks, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.TrackPermission))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.TrackPermission,
      syntax: :proto3
    }
  end
end
