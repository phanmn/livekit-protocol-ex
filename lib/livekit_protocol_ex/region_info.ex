...
defmodule LivekitProtocolEx.RegionInfo do
  @moduledoc false
  ...
  defstruct distance: 0, url: "", region: "", __uf__: []
  ...
  (
    ...
    defp encode_distance({acc, acc_size}, msg) do
      if msg.distance == 0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_int64(msg.distance)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RegionInfo))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RegionInfo,
      syntax: :proto3
    }
  end
end
