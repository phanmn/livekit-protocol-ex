...
defmodule LivekitProtocolEx.UpdateSIPDispatchRuleRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          action:
            {:replace, LivekitProtocolEx.SIPDispatchRuleInfo.t()}
            | {:update, LivekitProtocolEx.SIPDispatchRuleUpdate.t()}
            | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct action: nil, sip_dispatch_rule_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateSIPDispatchRuleRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
                     ...
                     {:action,
                      {:update,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPDispatchRuleUpdate.decode!(delimited)
                       )}}

                   _ ->
                     {:action,
                      {:update, LivekitProtocolEx.SIPDispatchRuleUpdate.decode!(delimited)}}
                 end
               ], rest}
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 case msg.action do
                   {:replace, previous_value} ->
                     {:action,
                      {:replace,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPDispatchRuleInfo.decode!(delimited)
                       )}}

                   _ ->
                     {:action,
                      {:replace, LivekitProtocolEx.SIPDispatchRuleInfo.decode!(delimited)}}
                 end
               ], rest}
    ...
    %{
      ...
      fields: %{
        replace: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :action},
          label: :optional,
          name: :replace,
          tag: 2,
          type: {:message, LivekitProtocolEx.SIPDispatchRuleInfo}
        },
        ...
        update: %{
          ...
          name: :update,
          tag: 3,
          type: {:message, LivekitProtocolEx.SIPDispatchRuleUpdate}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.UpdateSIPDispatchRuleRequest,
      syntax: :proto3
    }
  end
end
