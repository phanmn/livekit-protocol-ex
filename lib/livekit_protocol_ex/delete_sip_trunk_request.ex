...
defmodule LivekitProtocolEx.DeleteSIPTrunkRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DeleteSIPTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DeleteSIPTrunkRequest,
      syntax: :proto3
    }
  end
end
