...
defmodule LivekitProtocolEx.CreateSIPInboundTrunkRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          trunk: LivekitProtocolEx.SIPInboundTrunkInfo.t() | nil,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.CreateSIPInboundTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.CreateSIPInboundTrunkRequest,
      syntax: :proto3
    }
  end
end
