...
defmodule LivekitProtocolEx.SubscribedQualityUpdate do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          subscribed_codecs: [LivekitProtocolEx.SubscribedCodec.t()],
          subscribed_qualities: [LivekitProtocolEx.SubscribedQuality.t()],
          track_sid: String.t(),
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct subscribed_codecs: [], subscribed_qualities: [], track_sid: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_subscribed_codecs(msg)
        |> encode_subscribed_qualities(msg)
        |> encode_track_sid(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_subscribed_codecs({acc, acc_size}, msg) do
      case msg.subscribed_codecs do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:subscribed_codecs, "invalid field value"),
                __STACKTRACE__
    end

    defp encode_subscribed_qualities({acc, acc_size}, msg) do
      case msg.subscribed_qualities do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:subscribed_qualities, "invalid field value"),
                __STACKTRACE__
    end
    ...
    defp encode_track_sid({acc, acc_size}, msg) do
      if msg.track_sid == "" do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_string(msg.track_sid)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscribedQualityUpdate))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 subscribed_codecs:
                   msg.subscribed_codecs ++ [LivekitProtocolEx.SubscribedCodec.decode!(delimited)]
               ], rest}
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 subscribed_qualities:
                   msg.subscribed_qualities ++
                     [LivekitProtocolEx.SubscribedQuality.decode!(delimited)]
               ], rest}

            <<1::5, _wire_type::3, bytes::binary>> ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[track_sid: Protox.Decode.validate_string!(delimited)], rest}
  ...
  (
    ...
    def default(:subscribed_codecs) do
      {:error, :no_default_value}
    end

    def default(:subscribed_qualities) do
      {:error, :no_default_value}
    end
    ...
    %{
      ...
      fields: %{
        subscribed_codecs: %{
          ...
          tag: 3,
          type: {:message, LivekitProtocolEx.SubscribedCodec}
        },
        subscribed_qualities: %{
          __struct__: Protox.Field,
          extender: nil,
          ...
          tag: 2,
          type: {:message, LivekitProtocolEx.SubscribedQuality}
        },
        track_sid: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.SubscribedQualityUpdate,
      syntax: :proto3
    }
  end
end
