...
defmodule LivekitProtocolEx.RpcError do
  @moduledoc false
  ...
  defstruct data: "", message: "", code: 0, __uf__: []
  ...
  (
    ...
    defp encode_data({acc, acc_size}, msg) do
      if msg.data == "" do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_string(msg.data)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RpcError))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              ...
              {[data: Protox.Decode.validate_string!(delimited)], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RpcError,
      syntax: :proto3
    }
  end
end
