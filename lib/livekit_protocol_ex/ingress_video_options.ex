...
defmodule LivekitProtocolEx.IngressVideoOptions do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          encoding_options:
            {:preset, atom()}
            | {:options, LivekitProtocolEx.IngressVideoEncodingOptions.t()}
            | nil,
      ...
      case msg.encoding_options do
        ...
        {:preset, child_field_value} ->
          {value_bytes, value_bytes_size} =
            child_field_value
            |> LivekitProtocolEx.IngressVideoEncodingPreset.encode()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.IngressVideoOptions))
        end
      )
    )
                     ...
                     {:encoding_options,
                      {:options,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.IngressVideoEncodingOptions.decode!(delimited)
                       )}}

                   _ ->
                     {:encoding_options,
                      {:options, LivekitProtocolEx.IngressVideoEncodingOptions.decode!(delimited)}}
                 end
               ], rest}

            <<3::5, _wire_type::3, bytes::binary>> ->
              {value, rest} =
                Protox.Decode.parse_enum(bytes, LivekitProtocolEx.IngressVideoEncodingPreset)
    ...
    %{
      ...
      fields: %{
        ...
        options: %{
          ...
          name: :options,
          tag: 4,
          type: {:message, LivekitProtocolEx.IngressVideoEncodingOptions}
        },
        preset: %{
          __struct__: Protox.Field,
          extender: nil,
          ...
          name: :preset,
          tag: 3,
          type: {:enum, LivekitProtocolEx.IngressVideoEncodingPreset}
        },
        source: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.IngressVideoOptions,
      syntax: :proto3
    }
  end
end
