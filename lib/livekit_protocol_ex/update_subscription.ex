...
defmodule LivekitProtocolEx.UpdateSubscription do
  @moduledoc false
  ...
  defstruct participant_tracks: [], subscribe: false, track_sids: [], __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateSubscription))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateSubscription,
      syntax: :proto3
    }
  end
end
