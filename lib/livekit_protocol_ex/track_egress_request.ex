...
defmodule LivekitProtocolEx.TrackEgressRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          room_name: String.t(),
          output:
            {:file, LivekitProtocolEx.DirectFileOutput.t()} | {:websocket_url, String.t()} | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct webhooks: [], output: nil, track_id: "", room_name: "", __uf__: []
  ...
  (
    ...
    defp encode_output({acc, acc_size}, msg) do
      case msg.output do
        ...
        {:websocket_url, child_field_value} ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.TrackEgressRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<4::5, _wire_type::3, bytes::binary>> ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[output: {:websocket_url, Protox.Decode.validate_string!(delimited)}], rest}
                     ...
                     {:output,
                      {:file,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.DirectFileOutput.decode!(delimited)
                       )}}

                   _ ->
                     {:output, {:file, LivekitProtocolEx.DirectFileOutput.decode!(delimited)}}
                 end
               ], rest}
    ...
    %{
      ...
      fields: %{
        file: %{
          ...
          name: :file,
          tag: 3,
          type: {:message, LivekitProtocolEx.DirectFileOutput}
        },
        room_name: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.TrackEgressRequest,
      syntax: :proto3
    }
  end
end
