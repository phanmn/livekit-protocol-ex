...
defmodule LivekitProtocolEx.DeleteRoomRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DeleteRoomRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DeleteRoomRequest,
      syntax: :proto3
    }
  end
end
