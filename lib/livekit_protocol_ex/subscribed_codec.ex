...
defmodule LivekitProtocolEx.SubscribedCodec do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          qualities: [LivekitProtocolEx.SubscribedQuality.t()],
          codec: String.t(),
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct qualities: [], codec: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_qualities(msg)
        |> encode_codec(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_qualities({acc, acc_size}, msg) do
      case msg.qualities do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:qualities, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscribedCodec))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 qualities:
                   msg.qualities ++ [LivekitProtocolEx.SubscribedQuality.decode!(delimited)]
               ], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SubscribedCodec,
      syntax: :proto3
    }
  end
end
