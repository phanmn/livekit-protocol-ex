...
defmodule LivekitProtocolEx.UpdateSIPOutboundTrunkRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          action:
            {:replace, LivekitProtocolEx.SIPOutboundTrunkInfo.t()}
            | {:update, LivekitProtocolEx.SIPOutboundTrunkUpdate.t()}
            | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct action: nil, sip_trunk_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateSIPOutboundTrunkRequest))
        end
      )
    )
                     ...
                     {:action,
                      {:update,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPOutboundTrunkUpdate.decode!(delimited)
                       )}}

                   _ ->
                     {:action,
                      {:update, LivekitProtocolEx.SIPOutboundTrunkUpdate.decode!(delimited)}}
                 end
               ], rest}
                   ...
                   {:replace, previous_value} ->
                     {:action,
                      {:replace,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPOutboundTrunkInfo.decode!(delimited)
                       )}}

                   _ ->
                     {:action,
                      {:replace, LivekitProtocolEx.SIPOutboundTrunkInfo.decode!(delimited)}}
                 end
               ], rest}
    ...
    %{
      ...
      fields: %{
        replace: %{
          ...
          name: :replace,
          tag: 2,
          type: {:message, LivekitProtocolEx.SIPOutboundTrunkInfo}
        },
        sip_trunk_id: %{
          __struct__: Protox.Field,
          extender: nil,
        ...
        update: %{
          ...
          name: :update,
          tag: 3,
          type: {:message, LivekitProtocolEx.SIPOutboundTrunkUpdate}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.UpdateSIPOutboundTrunkRequest,
      syntax: :proto3
    }
  end
end
