...
defmodule LivekitProtocolEx.RoomMovedResponse do
  @moduledoc false
  ...
  defstruct other_participants: [], participant: nil, token: "", room: nil, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomMovedResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomMovedResponse,
      syntax: :proto3
    }
  end
end
