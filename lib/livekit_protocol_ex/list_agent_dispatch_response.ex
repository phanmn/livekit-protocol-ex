...
defmodule LivekitProtocolEx.ListAgentDispatchResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          agent_dispatches: [LivekitProtocolEx.AgentDispatch.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct agent_dispatches: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_agent_dispatches(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListAgentDispatchResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 agent_dispatches:
                   msg.agent_dispatches ++ [LivekitProtocolEx.AgentDispatch.decode!(delimited)]
               ], rest}
    ...
    %{
      ...
      fields: %{
        agent_dispatches: %{
          ...
          tag: 1,
          type: {:message, LivekitProtocolEx.AgentDispatch}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.ListAgentDispatchResponse,
      syntax: :proto3
    }
  end
end
