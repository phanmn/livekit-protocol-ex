...
defmodule LivekitProtocolEx.AgentDispatch do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          state: LivekitProtocolEx.AgentDispatchState.t() | nil,
          metadata: String.t(),
          room: String.t(),
          agent_name: String.t(),
          id: String.t(),
  ...
  defstruct state: nil, metadata: "", room: "", agent_name: "", id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.AgentDispatch))
        end
      )
    )
              ...
              {[
                 state:
                   Protox.MergeMessage.merge(
                     msg.state,
                     LivekitProtocolEx.AgentDispatchState.decode!(delimited)
                   )
               ], rest}
    ...
    %{
      ...
      fields: %{
        ...
        state: %{
          ...
          name: :state,
          tag: 5,
          type: {:message, LivekitProtocolEx.AgentDispatchState}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.AgentDispatch,
      syntax: :proto3
    }
  end
end
