...
defmodule LivekitProtocolEx.DeleteAgentDispatchRequest do
  @moduledoc false
  ...
  defstruct room: "", dispatch_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DeleteAgentDispatchRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DeleteAgentDispatchRequest,
      syntax: :proto3
    }
  end
end
