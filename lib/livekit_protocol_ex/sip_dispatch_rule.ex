...
defmodule LivekitProtocolEx.SIPDispatchRule do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          rule:
            {:dispatch_rule_direct, LivekitProtocolEx.SIPDispatchRuleDirect.t()}
            | {:dispatch_rule_individual, LivekitProtocolEx.SIPDispatchRuleIndividual.t()}
            | {:dispatch_rule_callee, LivekitProtocolEx.SIPDispatchRuleCallee.t()}
            | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct rule: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_rule(msg) |> encode_unknown_fields(msg)
      end
    )
    ...
    defp encode_rule({acc, acc_size}, msg) do
      case msg.rule do
        ...
        {:dispatch_rule_callee, child_field_value} ->
        ...
        {:dispatch_rule_individual, child_field_value} ->
          {value_bytes, value_bytes_size} = Protox.Encode.encode_message(child_field_value)
          {["\x12", value_bytes | acc], acc_size + 1 + value_bytes_size}

        {:dispatch_rule_direct, child_field_value} ->
          {value_bytes, value_bytes_size} = Protox.Encode.encode_message(child_field_value)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SIPDispatchRule))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 case msg.rule do
                   {:dispatch_rule_callee, previous_value} ->
                     {:rule,
                      {:dispatch_rule_callee,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPDispatchRuleCallee.decode!(delimited)
                       )}}
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 case msg.rule do
                   {:dispatch_rule_individual, previous_value} ->
                     {:rule,
                      {:dispatch_rule_individual,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPDispatchRuleIndividual.decode!(delimited)
                       )}}
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 case msg.rule do
                   {:dispatch_rule_direct, previous_value} ->
                     {:rule,
                      {:dispatch_rule_direct,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPDispatchRuleDirect.decode!(delimited)
                       )}}
  ...
  (
    ...
    def default(:dispatch_rule_callee) do
      {:error, :no_default_value}
    end

    def default(:dispatch_rule_individual) do
      {:error, :no_default_value}
    end

    def default(:dispatch_rule_direct) do
      {:error, :no_default_value}
    end
    ...
    %{
      ...
      fields: %{
        dispatch_rule_callee: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :rule},
          label: :optional,
          name: :dispatch_rule_callee,
          tag: 3,
          type: {:message, LivekitProtocolEx.SIPDispatchRuleCallee}
        },
        dispatch_rule_direct: %{
          __struct__: Protox.Field,
          extender: nil,
          ...
          tag: 1,
          type: {:message, LivekitProtocolEx.SIPDispatchRuleDirect}
        },
        dispatch_rule_individual: %{
          __struct__: Protox.Field,
          extender: nil,
          ...
          tag: 2,
          type: {:message, LivekitProtocolEx.SIPDispatchRuleIndividual}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.SIPDispatchRule,
      syntax: :proto3
    }
  end
end
