...
defmodule LivekitProtocolEx.ListSIPTrunkResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          items: [LivekitProtocolEx.SIPTrunkInfo.t()],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPTrunkResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[items: msg.items ++ [LivekitProtocolEx.SIPTrunkInfo.decode!(delimited)]], rest}
    ...
    %{
      ...
      fields: %{
        items: %{
          ...
          name: :items,
          tag: 1,
          type: {:message, LivekitProtocolEx.SIPTrunkInfo}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.ListSIPTrunkResponse,
      syntax: :proto3
    }
  end
end
