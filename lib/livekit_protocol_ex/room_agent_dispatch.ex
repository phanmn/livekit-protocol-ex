...
defmodule LivekitProtocolEx.RoomAgentDispatch do
  @moduledoc false
  ...
  defstruct metadata: "", agent_name: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomAgentDispatch))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomAgentDispatch,
      syntax: :proto3
    }
  end
end
