...
defmodule LivekitProtocolEx.UpdateSubscriptionsRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          participant_tracks: [LivekitProtocolEx.ParticipantTracks.t()],
          subscribe: boolean(),
          track_sids: [String.t()],
          identity: String.t(),
          room: String.t(),
  ...
  (
    ...
    defp encode_participant_tracks({acc, acc_size}, msg) do
      case msg.participant_tracks do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:participant_tracks, "invalid field value"),
                __STACKTRACE__
    end

    defp encode_subscribe({acc, acc_size}, msg) do
      if msg.subscribe == false do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_bool(msg.subscribe)
        {[" ", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:subscribe, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateSubscriptionsRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<5::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 participant_tracks:
                   msg.participant_tracks ++
                     [LivekitProtocolEx.ParticipantTracks.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def default(:participant_tracks) do
      {:error, :no_default_value}
    end

    def default(:subscribe) do
      {:ok, false}
    end
    ...
    %{
      ...
      fields: %{
        ...
        participant_tracks: %{
          ...
          tag: 5,
          type: {:message, LivekitProtocolEx.ParticipantTracks}
        },
        room: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.UpdateSubscriptionsRequest,
      syntax: :proto3
    }
  end
end
