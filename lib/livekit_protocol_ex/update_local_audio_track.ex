...
defmodule LivekitProtocolEx.UpdateLocalAudioTrack do
  @moduledoc false
  ...
  defstruct features: [], track_sid: "", __uf__: []
  ...
  (
    ...
    defp encode_features({acc, acc_size}, msg) do
      case msg.features do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:features, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateLocalAudioTrack))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[features: msg.features ++ [value]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateLocalAudioTrack,
      syntax: :proto3
    }
  end
end
