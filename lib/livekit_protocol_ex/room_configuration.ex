...
defmodule LivekitProtocolEx.RoomConfiguration do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomConfiguration))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomConfiguration,
      syntax: :proto3
    }
  end
end
