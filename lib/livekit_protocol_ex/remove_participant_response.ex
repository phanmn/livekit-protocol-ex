...
defmodule LivekitProtocolEx.RemoveParticipantResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RemoveParticipantResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RemoveParticipantResponse,
      syntax: :proto3
    }
  end
end
