...
defmodule LivekitProtocolEx.SubscribedAudioCodec do
  @moduledoc false
  ...
  defstruct enabled: false, codec: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscribedAudioCodec))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SubscribedAudioCodec,
      syntax: :proto3
    }
  end
end
