...
defmodule LivekitProtocolEx.UpdateSubscriptionsResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateSubscriptionsResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateSubscriptionsResponse,
      syntax: :proto3
    }
  end
end
