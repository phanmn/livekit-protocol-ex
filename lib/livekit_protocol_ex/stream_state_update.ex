...
defmodule LivekitProtocolEx.StreamStateUpdate do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          stream_states: [LivekitProtocolEx.StreamStateInfo.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct stream_states: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_stream_states(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_stream_states({acc, acc_size}, msg) do
      case msg.stream_states do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:stream_states, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.StreamStateUpdate))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 stream_states:
                   msg.stream_states ++ [LivekitProtocolEx.StreamStateInfo.decode!(delimited)]
               ], rest}
    ...
    %{
      ...
      fields: %{
        stream_states: %{
          ...
          name: :stream_states,
          tag: 1,
          type: {:message, LivekitProtocolEx.StreamStateInfo}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.StreamStateUpdate,
      syntax: :proto3
    }
  end
end
