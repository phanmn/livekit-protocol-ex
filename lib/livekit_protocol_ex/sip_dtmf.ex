...
defmodule LivekitProtocolEx.SipDTMF do
  @moduledoc false
  ...
  (
    ...
    defp encode_digit({acc, acc_size}, msg) do
      if msg.digit == "" do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_string(msg.digit)
        {["\"", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:digit, "invalid field value"), __STACKTRACE__
    end
    ...
    defp encode_code({acc, acc_size}, msg) do
      if msg.code == 0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.code)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SipDTMF))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<4::5, _wire_type::3, bytes::binary>> ->
              ...
              {[digit: Protox.Decode.validate_string!(delimited)], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SipDTMF,
      syntax: :proto3
    }
  end
end
