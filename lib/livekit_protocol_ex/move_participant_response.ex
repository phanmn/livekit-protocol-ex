...
defmodule LivekitProtocolEx.MoveParticipantResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MoveParticipantResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.MoveParticipantResponse,
      syntax: :proto3
    }
  end
end
