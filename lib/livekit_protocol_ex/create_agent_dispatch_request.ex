...
defmodule LivekitProtocolEx.CreateAgentDispatchRequest do
  @moduledoc false
  ...
  defstruct metadata: "", room: "", agent_name: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.CreateAgentDispatchRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.CreateAgentDispatchRequest,
      syntax: :proto3
    }
  end
end
