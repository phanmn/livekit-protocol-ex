...
defmodule LivekitProtocolEx.GetSIPInboundTrunkResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.GetSIPInboundTrunkResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.GetSIPInboundTrunkResponse,
      syntax: :proto3
    }
  end
end
