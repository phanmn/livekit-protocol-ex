...
defmodule LivekitProtocolEx.InputVideoState do
  @moduledoc false
  ...
  defstruct framerate: 0.0, height: 0, width: 0, average_bitrate: 0, mime_type: "", __uf__: []
  ...
  (
    ...
    defp encode_framerate({acc, acc_size}, msg) do
      if msg.framerate == 0.0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_double(msg.framerate)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.InputVideoState))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.InputVideoState,
      syntax: :proto3
    }
  end
end
