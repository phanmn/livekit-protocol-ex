...
defmodule LivekitProtocolEx.DataStream.Trailer do
  @moduledoc false
  ...
  defstruct attributes: %{}, reason: "", stream_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DataStream.Trailer))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DataStream.Trailer,
      syntax: :proto3
    }
  end
end
