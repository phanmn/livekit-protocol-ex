...
defmodule LivekitProtocolEx.ListSIPDispatchRuleResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          items: [LivekitProtocolEx.SIPDispatchRuleInfo.t()],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPDispatchRuleResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[items: msg.items ++ [LivekitProtocolEx.SIPDispatchRuleInfo.decode!(delimited)]],
               rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListSIPDispatchRuleResponse,
      syntax: :proto3
    }
  end
end
