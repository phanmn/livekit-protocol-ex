...
defmodule LivekitProtocolEx.MigrateJobRequest do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_job_ids(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_job_ids({acc, acc_size}, msg) do
      case msg.job_ids do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:job_ids, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MigrateJobRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[job_ids: msg.job_ids ++ [Protox.Decode.validate_string!(delimited)]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.MigrateJobRequest,
      syntax: :proto3
    }
  end
end
