...
defmodule LivekitProtocolEx.ForwardParticipantRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          destination_room: String.t(),
          identity: String.t(),
          room: String.t(),
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct destination_room: "", identity: "", room: "", __uf__: []
  ...
  (
    ...
    defp encode_destination_room({acc, acc_size}, msg) do
      if msg.destination_room == "" do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_string(msg.destination_room)
        {["\x1A", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:destination_room, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ForwardParticipantRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              ...
              {[destination_room: Protox.Decode.validate_string!(delimited)], rest}
  ...
  (
    ...
    def default(:destination_room) do
      {:ok, ""}
    end
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ForwardParticipantRequest,
      syntax: :proto3
    }
  end
end
