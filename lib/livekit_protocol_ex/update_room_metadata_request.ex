...
defmodule LivekitProtocolEx.UpdateRoomMetadataRequest do
  @moduledoc false
  ...
  defstruct metadata: "", room: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateRoomMetadataRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateRoomMetadataRequest,
      syntax: :proto3
    }
  end
end
