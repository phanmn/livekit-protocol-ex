...
defmodule LivekitProtocolEx.MetricsRecordingHeader do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          room_id: String.t(),
          enable_user_data_training: boolean() | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct enable_user_data_training: nil, room_id: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_enable_user_data_training(msg)
        |> encode_room_id(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_enable_user_data_training({acc, acc_size}, msg) do
      case msg.enable_user_data_training do
        nil ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:enable_user_data_training, "invalid field value"),
                __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MetricsRecordingHeader))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[enable_user_data_training: value], rest}
  ...
  (
    ...
    def default(:enable_user_data_training) do
  ...
  def schema() do
    %{
      ...
      fields: %{
        enable_user_data_training: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_enable_user_data_training},
      ...
      name: LivekitProtocolEx.MetricsRecordingHeader,
      syntax: :proto3
    }
  end
end
