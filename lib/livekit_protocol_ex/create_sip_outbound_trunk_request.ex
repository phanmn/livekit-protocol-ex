...
defmodule LivekitProtocolEx.CreateSIPOutboundTrunkRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          trunk: LivekitProtocolEx.SIPOutboundTrunkInfo.t() | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct trunk: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_trunk(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.CreateSIPOutboundTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.CreateSIPOutboundTrunkRequest,
      syntax: :proto3
    }
  end
end
