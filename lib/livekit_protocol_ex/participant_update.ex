...
defmodule LivekitProtocolEx.ParticipantUpdate do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ParticipantUpdate))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ParticipantUpdate,
      syntax: :proto3
    }
  end
end
