...
defmodule LivekitProtocolEx.IngressVideoEncodingOptions do
  @moduledoc false
  ...
  defstruct layers: [], frame_rate: 0.0, video_codec: :DEFAULT_VC, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.IngressVideoEncodingOptions))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.IngressVideoEncodingOptions,
      syntax: :proto3
    }
  end
end
