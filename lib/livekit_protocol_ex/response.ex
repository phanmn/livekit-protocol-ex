...
defmodule LivekitProtocolEx.RpcResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          request_id: String.t(),
          value: {:payload, String.t()} | {:error, LivekitProtocolEx.RpcError.t()} | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct value: nil, request_id: "", __uf__: []
  ...
  (
    ...
    defp encode_request_id({acc, acc_size}, msg) do
      if msg.request_id == "" do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_string(msg.request_id)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RpcResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
                     ...
                     {:value,
                      {:error,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.RpcError.decode!(delimited)
                       )}}

                   _ ->
                     {:value, {:error, LivekitProtocolEx.RpcError.decode!(delimited)}}
                 end
               ], rest}
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[value: {:payload, Protox.Decode.validate_string!(delimited)}], rest}
    ...
    %{
      ...
      fields: %{
        error: %{
          ...
          name: :error,
          tag: 3,
          type: {:message, LivekitProtocolEx.RpcError}
        },
        payload: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.RpcResponse,
      syntax: :proto3
    }
  end
end
