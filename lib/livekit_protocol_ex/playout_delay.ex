...
defmodule LivekitProtocolEx.PlayoutDelay do
  @moduledoc false
  ...
  defstruct max: 0, min: 0, enabled: false, __uf__: []
  ...
  (
    ...
    defp encode_max({acc, acc_size}, msg) do
      if msg.max == 0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.max)
    ...
    defp encode_min({acc, acc_size}, msg) do
      if msg.min == 0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.min)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.PlayoutDelay))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.PlayoutDelay,
      syntax: :proto3
    }
  end
end
