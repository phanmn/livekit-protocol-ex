...
defmodule LivekitProtocolEx.DataStream.ByteHeader do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DataStream.ByteHeader))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DataStream.ByteHeader,
      syntax: :proto3
    }
  end
end
