...
defmodule LivekitProtocolEx.VideoConfiguration do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          hardware_encoder: atom(),
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct hardware_encoder: :UNSET, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_hardware_encoder(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_hardware_encoder({acc, acc_size}, msg) do
      if msg.hardware_encoder == :UNSET do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.hardware_encoder
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:hardware_encoder, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.VideoConfiguration))
        end
      )
    )
  ...
  (
    ...
    def default(:hardware_encoder) do
      {:ok, :UNSET}
    end
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.VideoConfiguration,
      syntax: :proto3
    }
  end
end
