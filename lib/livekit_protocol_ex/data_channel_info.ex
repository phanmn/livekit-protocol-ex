...
defmodule LivekitProtocolEx.DataChannelInfo do
  @moduledoc false
  ...
  defstruct target: :PUBLISHER, id: 0, label: "", __uf__: []
  ...
  (
    ...
    defp encode_id({acc, acc_size}, msg) do
      if msg.id == 0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.id)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DataChannelInfo))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DataChannelInfo,
      syntax: :proto3
    }
  end
end
