...
defmodule LivekitProtocolEx.UpdateLayoutRequest do
  @moduledoc false
  ...
  defstruct layout: "", egress_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateLayoutRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateLayoutRequest,
      syntax: :proto3
    }
  end
end
