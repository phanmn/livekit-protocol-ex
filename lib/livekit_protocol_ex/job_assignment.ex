...
defmodule LivekitProtocolEx.JobAssignment do
  @moduledoc false
  ...
  defstruct token: "", url: nil, job: nil, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.JobAssignment))
        end
      )
    )
    ...
    %{
      ...
      fields: %{
        ...
        url: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_url},
      ...
      name: LivekitProtocolEx.JobAssignment,
      syntax: :proto3
    }
  end
end
