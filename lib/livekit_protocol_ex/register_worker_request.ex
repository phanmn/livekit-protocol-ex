...
defmodule LivekitProtocolEx.RegisterWorkerRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          agent_name: String.t(),
          allowed_permissions: LivekitProtocolEx.ParticipantPermission.t() | nil,
  ...
  (
    (
      ...
      def encode!(msg) do
        ...
        |> encode_allowed_permissions(msg)
    ...
    defp encode_allowed_permissions({acc, acc_size}, msg) do
      if msg.allowed_permissions == nil do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_message(msg.allowed_permissions)
        {[":", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:allowed_permissions, "invalid field value"),
                __STACKTRACE__
    end

    defp encode_namespace({acc, acc_size}, msg) do
      case msg.namespace do
        nil ->
          {acc, acc_size}
    ...
    defp encode_ping_interval({acc, acc_size}, msg) do
      if msg.ping_interval == 0 do
        ...
        {value_bytes, value_bytes_size} = Protox.Encode.encode_uint32(msg.ping_interval)
        {["(", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RegisterWorkerRequest))
        end
      )
    )
  ...
  (
    ...
    def default(:allowed_permissions) do
      {:ok, nil}
    end
    ...
    %{
      ...
      fields: %{
        ...
        namespace: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_namespace},
      ...
      name: LivekitProtocolEx.RegisterWorkerRequest,
      syntax: :proto3
    }
  end
end
