...
defmodule LivekitProtocolEx.RoomEgress do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          participant: LivekitProtocolEx.AutoParticipantEgress.t() | nil,
          tracks: LivekitProtocolEx.AutoTrackEgress.t() | nil,
          room: LivekitProtocolEx.RoomCompositeEgressRequest.t() | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct participant: nil, tracks: nil, room: nil, __uf__: []
  ...
  (
    ...
    defp encode_tracks({acc, acc_size}, msg) do
      if msg.tracks == nil do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_message(msg.tracks)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomEgress))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomEgress,
      syntax: :proto3
    }
  end
end
