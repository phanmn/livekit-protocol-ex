...
defmodule LivekitProtocolEx.RpcRequest do
  @moduledoc false
  ...
  defstruct version: 0, response_timeout_ms: 0, payload: "", method: "", id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RpcRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RpcRequest,
      syntax: :proto3
    }
  end
end
