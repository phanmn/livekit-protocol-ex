...
defmodule LivekitProtocolEx.SIPDispatchRuleDirect do
  @moduledoc false
  ...
  defstruct pin: "", room_name: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SIPDispatchRuleDirect))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SIPDispatchRuleDirect,
      syntax: :proto3
    }
  end
end
