...
defmodule LivekitProtocolEx.RoomParticipantIdentity do
  @moduledoc false
  ...
  defstruct identity: "", room: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomParticipantIdentity))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomParticipantIdentity,
      syntax: :proto3
    }
  end
end
