...
defmodule LivekitProtocolEx.ListEgressRequest do
  @moduledoc false
  ...
  defstruct active: false, egress_id: "", room_name: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListEgressRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListEgressRequest,
      syntax: :proto3
    }
  end
end
