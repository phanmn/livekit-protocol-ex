...
defmodule LivekitProtocolEx.GetSIPOutboundTrunkRequest do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_sip_trunk_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.GetSIPOutboundTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.GetSIPOutboundTrunkRequest,
      syntax: :proto3
    }
  end
end
