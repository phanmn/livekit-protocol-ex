...
defmodule LivekitProtocolEx.AgentDispatchState do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          deleted_at: integer(),
          created_at: integer(),
          jobs: [LivekitProtocolEx.Job.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct deleted_at: 0, created_at: 0, jobs: [], __uf__: []
  ...
  (
    ...
    defp encode_deleted_at({acc, acc_size}, msg) do
      if msg.deleted_at == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_int64(msg.deleted_at)
        {["\x18", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:deleted_at, "invalid field value"), __STACKTRACE__
    end
    ...
    defp encode_jobs({acc, acc_size}, msg) do
      case msg.jobs do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:jobs, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.AgentDispatchState))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[jobs: msg.jobs ++ [LivekitProtocolEx.Job.decode!(delimited)]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.AgentDispatchState,
      syntax: :proto3
    }
  end
end
