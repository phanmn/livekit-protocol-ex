...
defmodule LivekitProtocolEx.CreateIngressRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.CreateIngressRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.CreateIngressRequest,
      syntax: :proto3
    }
  end
end
