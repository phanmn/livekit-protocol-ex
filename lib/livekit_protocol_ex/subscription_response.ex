...
defmodule LivekitProtocolEx.SubscriptionResponse do
  @moduledoc false
  ...
  defstruct err: :SE_UNKNOWN, track_sid: "", __uf__: []
  ...
  (
    ...
    defp encode_err({acc, acc_size}, msg) do
      if msg.err == :SE_UNKNOWN do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.err |> LivekitProtocolEx.SubscriptionError.encode() |> Protox.Encode.encode_enum()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscriptionResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LivekitProtocolEx.SubscriptionError)
              {[err: value], rest}
    ...
    %{
      ...
      fields: %{
        err: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :SE_UNKNOWN},
          label: :optional,
          name: :err,
          tag: 2,
          type: {:enum, LivekitProtocolEx.SubscriptionError}
        },
        track_sid: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.SubscriptionResponse,
      syntax: :proto3
    }
  end
end
