...
defmodule LivekitProtocolEx.IngressAudioOptions do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          encoding_options:
            {:preset, atom()}
            | {:options, LivekitProtocolEx.IngressAudioEncodingOptions.t()}
            | nil,
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct encoding_options: nil, source: :UNKNOWN, name: "", __uf__: []
  ...
  (
    ...
    defp encode_encoding_options({acc, acc_size}, msg) do
      case msg.encoding_options do
        nil ->
          {acc, acc_size}

        {:options, child_field_value} ->
        ...
        {:preset, child_field_value} ->
          {value_bytes, value_bytes_size} =
            child_field_value
            |> LivekitProtocolEx.IngressAudioEncodingPreset.encode()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.IngressAudioOptions))
        end
      )
    )
                     ...
                     {:encoding_options,
                      {:options,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.IngressAudioEncodingOptions.decode!(delimited)
                       )}}

                   _ ->
                     {:encoding_options,
                      {:options, LivekitProtocolEx.IngressAudioEncodingOptions.decode!(delimited)}}
                 end
               ], rest}

            <<3::5, _wire_type::3, bytes::binary>> ->
              {value, rest} =
                Protox.Decode.parse_enum(bytes, LivekitProtocolEx.IngressAudioEncodingPreset)

              {[encoding_options: {:preset, value}], rest}
    ...
    %{
      ...
      fields: %{
        ...
        options: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :encoding_options},
          label: :optional,
          name: :options,
          tag: 4,
          type: {:message, LivekitProtocolEx.IngressAudioEncodingOptions}
        },
        preset: %{
          __struct__: Protox.Field,
          extender: nil,
          ...
          name: :preset,
          tag: 3,
          type: {:enum, LivekitProtocolEx.IngressAudioEncodingPreset}
        },
        source: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.IngressAudioOptions,
      syntax: :proto3
    }
  end
end
