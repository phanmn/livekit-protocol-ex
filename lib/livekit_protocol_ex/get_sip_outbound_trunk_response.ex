...
defmodule LivekitProtocolEx.GetSIPOutboundTrunkResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.GetSIPOutboundTrunkResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.GetSIPOutboundTrunkResponse,
      syntax: :proto3
    }
  end
end
