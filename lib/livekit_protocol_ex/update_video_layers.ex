...
defmodule LivekitProtocolEx.UpdateVideoLayers do
  @moduledoc false
  ...
  defstruct layers: [], track_sid: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateVideoLayers))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateVideoLayers,
      syntax: :proto3
    }
  end
end
