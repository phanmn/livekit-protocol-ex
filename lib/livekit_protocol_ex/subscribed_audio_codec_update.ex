...
defmodule LivekitProtocolEx.SubscribedAudioCodecUpdate do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          subscribed_audio_codecs: [LivekitProtocolEx.SubscribedAudioCodec.t()],
          track_sid: String.t(),
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct subscribed_audio_codecs: [], track_sid: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_subscribed_audio_codecs(msg)
        |> encode_track_sid(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_subscribed_audio_codecs({acc, acc_size}, msg) do
      case msg.subscribed_audio_codecs do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:subscribed_audio_codecs, "invalid field value"),
                __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscribedAudioCodecUpdate))
        end
      )
    )
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 subscribed_audio_codecs:
                   msg.subscribed_audio_codecs ++
                     [LivekitProtocolEx.SubscribedAudioCodec.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def default(:subscribed_audio_codecs) do
    ...
    %{
      ...
      fields: %{
        subscribed_audio_codecs: %{
          ...
          tag: 2,
          type: {:message, LivekitProtocolEx.SubscribedAudioCodec}
        },
        track_sid: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.SubscribedAudioCodecUpdate,
      syntax: :proto3
    }
  end
end
