...
defmodule LivekitProtocolEx.UpdateLocalVideoTrack do
  @moduledoc false
  ...
  defstruct height: 0, width: 0, track_sid: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateLocalVideoTrack))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.UpdateLocalVideoTrack,
      syntax: :proto3
    }
  end
end
