...
defmodule LivekitProtocolEx.ActiveSpeakerUpdate do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          speakers: [LivekitProtocolEx.SpeakerInfo.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct speakers: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_speakers(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_speakers({acc, acc_size}, msg) do
      case msg.speakers do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:speakers, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ActiveSpeakerUpdate))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[speakers: msg.speakers ++ [LivekitProtocolEx.SpeakerInfo.decode!(delimited)]],
               rest}
    ...
    %{
      ...
      fields: %{
        speakers: %{
          ...
          name: :speakers,
          tag: 1,
          type: {:message, LivekitProtocolEx.SpeakerInfo}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.ActiveSpeakerUpdate,
      syntax: :proto3
    }
  end
end
