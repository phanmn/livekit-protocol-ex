...
defmodule LivekitProtocolEx.UpdateSIPInboundTrunkRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          action:
            {:replace, LivekitProtocolEx.SIPInboundTrunkInfo.t()}
            | {:update, LivekitProtocolEx.SIPInboundTrunkUpdate.t()}
            | nil,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.UpdateSIPInboundTrunkRequest))
        end
      )
    )
                     ...
                     {:action,
                      {:update,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPInboundTrunkUpdate.decode!(delimited)
                       )}}

                   _ ->
                     {:action,
                      {:update, LivekitProtocolEx.SIPInboundTrunkUpdate.decode!(delimited)}}
                 end
               ], rest}
                   ...
                   {:replace, previous_value} ->
                     {:action,
                      {:replace,
                       Protox.MergeMessage.merge(
                         previous_value,
                         LivekitProtocolEx.SIPInboundTrunkInfo.decode!(delimited)
                       )}}

                   _ ->
                     {:action,
                      {:replace, LivekitProtocolEx.SIPInboundTrunkInfo.decode!(delimited)}}
                 end
               ], rest}
    ...
    %{
      ...
      fields: %{
        replace: %{
          ...
          name: :replace,
          tag: 2,
          type: {:message, LivekitProtocolEx.SIPInboundTrunkInfo}
        },
        sip_trunk_id: %{
          __struct__: Protox.Field,
          extender: nil,
        ...
        update: %{
          ...
          name: :update,
          tag: 3,
          type: {:message, LivekitProtocolEx.SIPInboundTrunkUpdate}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.UpdateSIPInboundTrunkRequest,
      syntax: :proto3
    }
  end
end
