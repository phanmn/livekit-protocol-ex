...
defmodule LivekitProtocolEx.ConnectionQualityUpdate do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          updates: [LivekitProtocolEx.ConnectionQualityInfo.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct updates: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_updates(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_updates({acc, acc_size}, msg) do
      case msg.updates do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:updates, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ConnectionQualityUpdate))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 updates:
                   msg.updates ++ [LivekitProtocolEx.ConnectionQualityInfo.decode!(delimited)]
               ], rest}
    ...
    %{
      ...
      fields: %{
        updates: %{
          ...
          name: :updates,
          tag: 1,
          type: {:message, LivekitProtocolEx.ConnectionQualityInfo}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.ConnectionQualityUpdate,
      syntax: :proto3
    }
  end
end
