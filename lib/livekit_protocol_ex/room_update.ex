...
defmodule LivekitProtocolEx.RoomUpdate do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomUpdate))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomUpdate,
      syntax: :proto3
    }
  end
end
