...
defmodule LivekitProtocolEx.ForwardParticipantResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ForwardParticipantResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ForwardParticipantResponse,
      syntax: :proto3
    }
  end
end
