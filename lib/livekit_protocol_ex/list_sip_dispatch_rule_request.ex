...
defmodule LivekitProtocolEx.ListSIPDispatchRuleRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          page: LivekitProtocolEx.Pagination.t() | nil,
          trunk_ids: [String.t()],
          dispatch_rule_ids: [String.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct page: nil, trunk_ids: [], dispatch_rule_ids: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        ...
        |> encode_dispatch_rule_ids(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_page({acc, acc_size}, msg) do
      if msg.page == nil do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_message(msg.page)
        {["\x1A", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:page, "invalid field value"), __STACKTRACE__
    end
    ...
    defp encode_dispatch_rule_ids({acc, acc_size}, msg) do
      case msg.dispatch_rule_ids do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:dispatch_rule_ids, "invalid field value"),
                __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPDispatchRuleRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
              ...
              {[
                 page:
                   Protox.MergeMessage.merge(
                     msg.page,
                     LivekitProtocolEx.Pagination.decode!(delimited)
                   )
               ], rest}
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 dispatch_rule_ids:
                   msg.dispatch_rule_ids ++ [Protox.Decode.validate_string!(delimited)]
               ], rest}
  ...
  (
    ...
    def default(:dispatch_rule_ids) do
      {:error, :no_default_value}
    end
    ...
    %{
      ...
      fields: %{
        ...
        page: %{
          ...
          name: :page,
          tag: 3,
          type: {:message, LivekitProtocolEx.Pagination}
        },
        trunk_ids: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.ListSIPDispatchRuleRequest,
      syntax: :proto3
    }
  end
end
