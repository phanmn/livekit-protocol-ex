...
defmodule LivekitProtocolEx.ProxyConfig do
  @moduledoc false
  ...
  defstruct password: "", username: "", url: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ProxyConfig))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ProxyConfig,
      syntax: :proto3
    }
  end
end
