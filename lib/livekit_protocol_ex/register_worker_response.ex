...
defmodule LivekitProtocolEx.RegisterWorkerResponse do
  @moduledoc false
  ...
  defstruct server_info: nil, worker_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RegisterWorkerResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RegisterWorkerResponse,
      syntax: :proto3
    }
  end
end
