...
defmodule LivekitProtocolEx.TokenPagination do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_token(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.TokenPagination))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.TokenPagination,
      syntax: :proto3
    }
  end
end
