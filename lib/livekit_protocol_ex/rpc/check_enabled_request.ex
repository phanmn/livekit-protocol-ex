...
defmodule LivekitProtocolEx.Rpc.CheckEnabledRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.CheckEnabledRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.CheckEnabledRequest,
      syntax: :proto3
    }
  end
end
