...
defmodule LivekitProtocolEx.Rpc.WatchLocalLinksRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.WatchLocalLinksRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.WatchLocalLinksRequest,
      syntax: :proto3
    }
  end
end
