...
defmodule LivekitProtocolEx.Rpc.JobRequestResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.JobRequestResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.JobRequestResponse,
      syntax: :proto3
    }
  end
end
