...
defmodule LivekitProtocolEx.Rpc.UpdateIngressStateRequest do
  @moduledoc false
  ...
  defstruct state: nil, ingress_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.UpdateIngressStateRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.UpdateIngressStateRequest,
      syntax: :proto3
    }
  end
end
