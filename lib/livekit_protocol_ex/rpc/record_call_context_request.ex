...
defmodule LivekitProtocolEx.Rpc.RecordCallContextRequest do
  @moduledoc false
  ...
  defstruct call_info: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_call_info(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.RecordCallContextRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.RecordCallContextRequest,
      syntax: :proto3
    }
  end
end
