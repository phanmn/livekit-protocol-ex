...
defmodule LivekitProtocolEx.Rpc.GetIngressInfoRequest do
  @moduledoc false
  ...
  defstruct stream_key: "", ingress_id: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.GetIngressInfoRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.GetIngressInfoRequest,
      syntax: :proto3
    }
  end
end
