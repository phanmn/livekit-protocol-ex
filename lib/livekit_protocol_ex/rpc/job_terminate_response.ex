...
defmodule LivekitProtocolEx.Rpc.JobTerminateResponse do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_state(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.JobTerminateResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.JobTerminateResponse,
      syntax: :proto3
    }
  end
end
