...
defmodule LivekitProtocolEx.Rpc.JobTerminateRequest do
  @moduledoc false
  ...
  defstruct reason: :TERMINATION_REQUESTED, job_id: "", __uf__: []
  ...
  (
    ...
    defp encode_reason({acc, acc_size}, msg) do
      if msg.reason == :TERMINATION_REQUESTED do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.reason
          |> LivekitProtocolEx.Rpc.JobTerminateReason.encode()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.JobTerminateRequest))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              {value, rest} =
                Protox.Decode.parse_enum(bytes, LivekitProtocolEx.Rpc.JobTerminateReason)
    ...
    %{
      ...
      fields: %{
        ...
        reason: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :TERMINATION_REQUESTED},
          label: :optional,
          name: :reason,
          tag: 2,
          type: {:enum, LivekitProtocolEx.Rpc.JobTerminateReason}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.Rpc.JobTerminateRequest,
      syntax: :proto3
    }
  end
end
