...
defmodule LivekitProtocolEx.Rpc.SimulateLinkStateResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.SimulateLinkStateResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.Rpc.SimulateLinkStateResponse,
      syntax: :proto3
    }
  end
end
