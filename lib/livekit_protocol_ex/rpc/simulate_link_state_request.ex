...
defmodule LivekitProtocolEx.Rpc.SimulateLinkStateRequest do
  @moduledoc false
  ...
  (
    ...
    defp encode_timeout({acc, acc_size}, msg) do
      if msg.timeout == 0 do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_int64(msg.timeout)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.Rpc.SimulateLinkStateRequest))
        end
      )
    )
    ...
    %{
      ...
      fields: %{
        disabled: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_disabled},
        ...
        jitter: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_jitter},
          label: :proto3_optional,
          name: :jitter,
          tag: 4,
          type: :int64
        ...
        packet_loss: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_packet_loss},
          label: :proto3_optional,
          name: :packet_loss,
          tag: 5,
          type: :double
        ...
        rtt: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.OneOf, parent: :_rtt},
          label: :proto3_optional,
          name: :rtt,
          tag: 3,
          type: :int64
      ...
      name: LivekitProtocolEx.Rpc.SimulateLinkStateRequest,
      syntax: :proto3
    }
  end
end
