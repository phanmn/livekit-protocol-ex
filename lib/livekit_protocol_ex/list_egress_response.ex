...
defmodule LivekitProtocolEx.ListEgressResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          items: [LivekitProtocolEx.EgressInfo.t()],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListEgressResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[items: msg.items ++ [LivekitProtocolEx.EgressInfo.decode!(delimited)]], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListEgressResponse,
      syntax: :proto3
    }
  end
end
