...
defmodule LivekitProtocolEx.DeleteRoomResponse do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.DeleteRoomResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.DeleteRoomResponse,
      syntax: :proto3
    }
  end
end
