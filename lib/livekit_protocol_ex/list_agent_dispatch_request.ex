...
defmodule LivekitProtocolEx.ListAgentDispatchRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListAgentDispatchRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListAgentDispatchRequest,
      syntax: :proto3
    }
  end
end
