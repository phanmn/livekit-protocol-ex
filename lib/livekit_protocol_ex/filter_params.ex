...
defmodule LivekitProtocolEx.FilterParams do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          exclude_events: [String.t()],
          include_events: [String.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct exclude_events: [], include_events: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0}
        |> encode_exclude_events(msg)
        |> encode_include_events(msg)
        |> encode_unknown_fields(msg)
      end
    )

    defp encode_exclude_events({acc, acc_size}, msg) do
      case msg.exclude_events do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:exclude_events, "invalid field value"), __STACKTRACE__
    end

    defp encode_include_events({acc, acc_size}, msg) do
      case msg.include_events do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:include_events, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.FilterParams))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<2::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 exclude_events: msg.exclude_events ++ [Protox.Decode.validate_string!(delimited)]
               ], rest}
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 include_events: msg.include_events ++ [Protox.Decode.validate_string!(delimited)]
               ], rest}
  ...
  (
    ...
    def default(:exclude_events) do
      {:error, :no_default_value}
    end

    def default(:include_events) do
      {:error, :no_default_value}
    end
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.FilterParams,
      syntax: :proto3
    }
  end
end
