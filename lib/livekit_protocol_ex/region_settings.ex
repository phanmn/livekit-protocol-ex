...
defmodule LivekitProtocolEx.RegionSettings do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          regions: [LivekitProtocolEx.RegionInfo.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct regions: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_regions(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RegionSettings))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[regions: msg.regions ++ [LivekitProtocolEx.RegionInfo.decode!(delimited)]], rest}
    ...
    %{
      ...
      fields: %{
        regions: %{
          ...
          name: :regions,
          tag: 1,
          type: {:message, LivekitProtocolEx.RegionInfo}
        }
      },
      file_options: %{
      ...
      name: LivekitProtocolEx.RegionSettings,
      syntax: :proto3
    }
  end
end
