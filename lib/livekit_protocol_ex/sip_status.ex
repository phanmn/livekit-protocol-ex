...
defmodule LivekitProtocolEx.SIPStatus do
  @moduledoc false
  ...
  defstruct status: "", code: :SIP_STATUS_UNKNOWN, __uf__: []
  ...
  (
    ...
    defp encode_code({acc, acc_size}, msg) do
      if msg.code == :SIP_STATUS_UNKNOWN do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.code |> LivekitProtocolEx.SIPStatusCode.encode() |> Protox.Encode.encode_enum()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SIPStatus))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LivekitProtocolEx.SIPStatusCode)
              {[code: value], rest}
    ...
    %{
      ...
      fields: %{
        code: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :SIP_STATUS_UNKNOWN},
          label: :optional,
          name: :code,
          tag: 1,
          type: {:enum, LivekitProtocolEx.SIPStatusCode}
        },
        status: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.SIPStatus,
      syntax: :proto3
    }
  end
end
