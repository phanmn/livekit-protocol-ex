...
defmodule LivekitProtocolEx.SIPParticipantInfo do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SIPParticipantInfo))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SIPParticipantInfo,
      syntax: :proto3
    }
  end
end
