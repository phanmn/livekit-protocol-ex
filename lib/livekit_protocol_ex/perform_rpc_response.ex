...
defmodule LivekitProtocolEx.PerformRpcResponse do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_payload(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.PerformRpcResponse))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.PerformRpcResponse,
      syntax: :proto3
    }
  end
end
