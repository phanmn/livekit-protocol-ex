...
defmodule LivekitProtocolEx.JobTermination do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_job_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.JobTermination))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.JobTermination,
      syntax: :proto3
    }
  end
end
