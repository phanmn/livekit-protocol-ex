...
defmodule LivekitProtocolEx.ListSIPInboundTrunkResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          items: [LivekitProtocolEx.SIPInboundTrunkInfo.t()],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListSIPInboundTrunkResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[items: msg.items ++ [LivekitProtocolEx.SIPInboundTrunkInfo.decode!(delimited)]],
               rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListSIPInboundTrunkResponse,
      syntax: :proto3
    }
  end
end
