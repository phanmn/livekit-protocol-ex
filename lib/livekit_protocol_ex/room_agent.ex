...
defmodule LivekitProtocolEx.RoomAgent do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          dispatches: [LivekitProtocolEx.RoomAgentDispatch.t()],
          __uf__: [{non_neg_integer(), Protox.Types.tag(), binary()}]
        }
  defstruct dispatches: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_dispatches(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_dispatches({acc, acc_size}, msg) do
      case msg.dispatches do
        [] ->
          {acc, acc_size}
      ...
      ArgumentError ->
        reraise Protox.EncodingError.new(:dispatches, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.RoomAgent))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 dispatches:
                   msg.dispatches ++ [LivekitProtocolEx.RoomAgentDispatch.decode!(delimited)]
               ], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.RoomAgent,
      syntax: :proto3
    }
  end
end
