...
defmodule LivekitProtocolEx.StreamOutput do
  @moduledoc false
  ...
  defstruct urls: [], protocol: :DEFAULT_PROTOCOL, __uf__: []
  ...
  (
    ...
    defp encode_protocol({acc, acc_size}, msg) do
      if msg.protocol == :DEFAULT_PROTOCOL do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.protocol |> LivekitProtocolEx.StreamProtocol.encode() |> Protox.Encode.encode_enum()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.StreamOutput))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LivekitProtocolEx.StreamProtocol)
              {[protocol: value], rest}
    ...
    %{
      ...
      fields: %{
        protocol: %{
          ...
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :DEFAULT_PROTOCOL},
          label: :optional,
          name: :protocol,
          tag: 1,
          type: {:enum, LivekitProtocolEx.StreamProtocol}
        },
        urls: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.StreamOutput,
      syntax: :proto3
    }
  end
end
