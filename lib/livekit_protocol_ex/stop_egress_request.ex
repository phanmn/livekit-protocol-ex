...
defmodule LivekitProtocolEx.StopEgressRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.StopEgressRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.StopEgressRequest,
      syntax: :proto3
    }
  end
end
