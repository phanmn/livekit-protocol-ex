...
defmodule LivekitProtocolEx.ConnectionSettings do
  @moduledoc false
  ...
  defstruct disable_ice_lite: false,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ConnectionSettings))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ConnectionSettings,
      syntax: :proto3
    }
  end
end
