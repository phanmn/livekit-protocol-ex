...
defmodule LivekitProtocolEx.CreateSIPDispatchRuleRequest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          dispatch_rule: LivekitProtocolEx.SIPDispatchRuleInfo.t() | nil,
  ...
  (
    ...
    defp encode_dispatch_rule({acc, acc_size}, msg) do
      if msg.dispatch_rule == nil do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_message(msg.dispatch_rule)
        {["R", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:dispatch_rule, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.CreateSIPDispatchRuleRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.CreateSIPDispatchRuleRequest,
      syntax: :proto3
    }
  end
end
