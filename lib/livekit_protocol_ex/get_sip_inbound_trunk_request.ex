...
defmodule LivekitProtocolEx.GetSIPInboundTrunkRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.GetSIPInboundTrunkRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.GetSIPInboundTrunkRequest,
      syntax: :proto3
    }
  end
end
