...
defmodule LivekitProtocolEx.SubscriptionPermissionUpdate do
  @moduledoc false
  ...
  defstruct allowed: false, track_sid: "", participant_sid: "", __uf__: []
  ...
  (
    ...
    defp encode_allowed({acc, acc_size}, msg) do
      if msg.allowed == false do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_bool(msg.allowed)
        {["\x18", value_bytes | acc], acc_size + 1 + value_bytes_size}
      end
    rescue
      ArgumentError ->
        reraise Protox.EncodingError.new(:allowed, "invalid field value"), __STACKTRACE__
    end
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscriptionPermissionUpdate))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SubscriptionPermissionUpdate,
      syntax: :proto3
    }
  end
end
