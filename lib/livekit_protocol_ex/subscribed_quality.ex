...
defmodule LivekitProtocolEx.SubscribedQuality do
  @moduledoc false
  ...
  defstruct enabled: false, quality: :LOW, __uf__: []
  ...
  (
    ...
    defp encode_enabled({acc, acc_size}, msg) do
      if msg.enabled == false do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} = Protox.Encode.encode_bool(msg.enabled)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.SubscribedQuality))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.SubscribedQuality,
      syntax: :proto3
    }
  end
end
