...
defmodule LivekitProtocolEx.StreamStateInfo do
  @moduledoc false
  ...
  defstruct state: :ACTIVE, track_sid: "", participant_sid: "", __uf__: []
  ...
  (
    ...
    defp encode_state({acc, acc_size}, msg) do
      if msg.state == :ACTIVE do
        {acc, acc_size}
      else
        {value_bytes, value_bytes_size} =
          msg.state |> LivekitProtocolEx.StreamState.encode() |> Protox.Encode.encode_enum()
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.StreamStateInfo))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<3::5, _wire_type::3, bytes::binary>> ->
              {value, rest} = Protox.Decode.parse_enum(bytes, LivekitProtocolEx.StreamState)
              {[state: value], rest}
    ...
    %{
      ...
      fields: %{
        ...
        state: %{
          __struct__: Protox.Field,
          extender: nil,
          kind: %{__struct__: Protox.Scalar, default_value: :ACTIVE},
          label: :optional,
          name: :state,
          tag: 3,
          type: {:enum, LivekitProtocolEx.StreamState}
        },
        track_sid: %{
          __struct__: Protox.Field,
          extender: nil,
      ...
      name: LivekitProtocolEx.StreamStateInfo,
      syntax: :proto3
    }
  end
end
