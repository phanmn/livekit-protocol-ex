...
defmodule LivekitProtocolEx.MoveParticipantRequest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.MoveParticipantRequest))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.MoveParticipantRequest,
      syntax: :proto3
    }
  end
end
