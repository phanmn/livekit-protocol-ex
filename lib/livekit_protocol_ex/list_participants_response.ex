...
defmodule LivekitProtocolEx.ListParticipantsResponse do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          participants: [LivekitProtocolEx.ParticipantInfo.t()],
  ...
  (
    (
      ...
      def encode!(msg) do
        {_acc = [], _acc_size = 0} |> encode_participants(msg) |> encode_unknown_fields(msg)
      end
    )

    defp encode_participants({acc, acc_size}, msg) do
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.ListParticipantsResponse))
        end
      )
    )
        ...
        {field, rest} =
          case bytes do
            ...
            <<1::5, _wire_type::3, bytes::binary>> ->
              ...
              {[
                 participants:
                   msg.participants ++ [LivekitProtocolEx.ParticipantInfo.decode!(delimited)]
               ], rest}
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.ListParticipantsResponse,
      syntax: :proto3
    }
  end
end
