...
defmodule LivekitProtocolEx.IngressAudioEncodingOptions do
  @moduledoc false
  ...
  defstruct channels: 0, disable_dtx: false, bitrate: 0, audio_codec: :DEFAULT_AC, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(LivekitProtocolEx.IngressAudioEncodingOptions))
        end
      )
    )
  ...
  def schema() do
    %{
      ...
      name: LivekitProtocolEx.IngressAudioEncodingOptions,
      syntax: :proto3
    }
  end
end
